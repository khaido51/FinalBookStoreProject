...
<!-- Favicon -->
<link rel="shortcut icon" type="image/x-icon" href="https://raw.githubusercontent.com/yellowmacaron/project-img/main/smalllogo.png">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="login-title text-center mb-30">
						...
						${errorMessage}
						<p>
							Welcome to Whisper & Wonder Bookstore. Log in with your username and password.
						</p>
				...
				<div class="row bt-2">
					<div class="col-lg-6 col-md-6 col-12">
						<div class="copy-right-area">
							<p>
								&copy; 2022 <strong>  </strong> Mede with ❤️ by <a
