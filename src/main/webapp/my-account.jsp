...
<link rel="shortcut icon" type="image/x-icon"
	href="https://raw.githubusercontent.com/yellowmacaron/project-img/main/smalllogo.png">icon.png">
                                        ...
                                        <div class="tab-content" id="myaccountContent">
                                            ...
                                            <div class="tab-pane fade show active" id="dashboad" role="tabpanel">
                                                <div class="myaccount-content">
                                                    <h5>Dashboard</h5>
                                                    <div class="welcome">
                                                        <p>Hello, <strong>${userName }</strong> (If Not <strong>${userName }
                                                            !</strong><a href="logout" class="logout"> Logout</a>)</p>
                                                    </div>
                                                    <p class="mb-0">Welcome to our book store. You can easily check &
                                                        ...
                                                        <table class="table table-bordered">
                                                            ...
                                                            <c:forEach var="item" items="${orderList }">
                                                                <tr>
                                                                    ...
                                                                    <td><a href="order-details?orderId=${item.id }" class="btn btn-sqr">View</a>
                                                                    </td>
                                                                </tr>
                                                              </c:forEach>
                                                            </tbody>
                                            ...
                                            <div class="tab-pane fade" id="address-edit" role="tabpanel">
                                                <div class="myaccount-content">
                                                    ...
                                                    <address>
                                                        ...
                                                        <p>${address.streetNo } ${address.streetName }<br>
                                                        <p>${address.suburb } ${address.postcode } ${address.state }<br>
